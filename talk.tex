...
% \subtitle{How to learn contact-rich manipulation skills?}
...
\begin{frame}[t]
  \begin{itemize}
    \item The 7th UK Robot Manipulation Workshop
    \begin{itemize}
      \item 6--7 January (2026)
      \item \href{https://www.robot-manipulation.uk}{https://www.robot-manipulation.uk}
    \end{itemize}
    \item ROSCON UK 25
    \begin{itemize}
      \item 15--17 September (2026)
      \item \href{https://roscon.org.uk/2025/}{https://roscon.org.uk/2025/}
    \end{itemize}
  \end{itemize}
\end{frame}
