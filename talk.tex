...
\begin{frame}{Contact-rich Manipulation}{Catching fast, large, and heavy boxes}
  ...
  \begin{figure}[h]
    \movie[
      ...
      height=\heightVideo,
    ]{\includegraphics[height=\heightVideo]{images/catchingFlyingBox.png}}{videos/catchingFlyingBox.mp4}
  \end{figure}
  ...
  \begin{tikzpicture}[overlay, remember picture]
    ...
    % -----
    \node[anchor=south] (lei) at (theo.north) [yshift=5mm] {
...
\begin{frame}{Contact-rich Manipulation}{MPC for non-prehensile pushing}
  ...
  \movie[
    ...
    % repeat,
    showcontrols
  ]{\includegraphics[height=\heightVideoFull]{images/moura.png}}{videos/moura.mp4}
  \footfullcitenomark{Moura2022}
\end{frame}
...
\begin{frame}{Contact-rich Manipulation}{RL for non-prehensile pushing}
  ...
  \begin{tikzpicture}[overlay, remember picture]
    % photos of colaborators
    \node[anchor=south east] (juan) at (current page.south east) [xshift=-3mm, yshift=10mm] {
...
\begin{frame}{Contact-rich Manipulation}{RL for non-prehensile pushing}
  ...
  \movie[
    ...
    % repeat,
    showcontrols,
  ]{\includegraphics[height=\heightVideoFull]{images/physical_robot.png}}{images/physical_robot.mp4}
